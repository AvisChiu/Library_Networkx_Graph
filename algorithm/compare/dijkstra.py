...
def dijkstra(start,terminal):
    cost = 0
    path = nx.dijkstra_path(G, start, terminal)
    cost = nx.dijkstra_path_length(G, start, terminal)
    # print("Dijkstra Shortest Path: ")
    # for i in range(len(path)-1):
        # print(path[i],"->",path[i+1])
    # print("Dijkstra Shortest Path Cost: ",cost)
...
if __name__ == "__main__":
    ...
    for i in range(1000):
        ...
        dijkstra(get_s_t[0],get_s_t[1])                 # Djikstra Algorithm
        # draw()
